...
try
{
	...
	$query = 'INSERT INTO scripturesOC(book, chapter, verse, content) VALUES(:book, :chapter, :verse, :content)';
	...
	// get the new id
	$scriptureId = $db->lastInsertId("scripturesOC_id_seq");
	...
	foreach ($topicIds as $topicId)
	{
		...
		$statement = $db->prepare('INSERT INTO scripture_topicOC(scriptureId, topicId) VALUES(:scriptureId, :topicId)');
